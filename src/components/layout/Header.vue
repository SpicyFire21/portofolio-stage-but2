<template>
  <header class="fixed w-full bg-[var(--white)]  border-b border-[var(--primary)] text-[var(--white)] flex flex-col items-center justify-center">
...
const buttons = [
  {href:"/",name:"Accueil"},
  {href:"/tech",name:"Technique"},
  {href:"/proj",name:"Projet"},
